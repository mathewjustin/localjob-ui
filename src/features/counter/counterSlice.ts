...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    addValue: (state, action: PayloadAction<Custom>)=>{
      console.log("inside addvalue");
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(incrementAsync.fulfilled, (state, action) => {
        state.status = 'idle';
        state.value += action.payload;
      }).addCase(calllocaljobsapi.fulfilled, (state, action) => {
        state.status = 'idle';
...
export const { increment, decrement, incrementByAmount,addValue } = counterSlice.actions;
